...
**Model is not as accurate as we imagine. The text in reference text may sound very bad, or may have been judged very harshly. When predicting on virgin text (when virgin text is scored based on ref), this leads model to believe that movies are not liked.**
